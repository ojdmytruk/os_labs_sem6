...
namespace OS_lab3
{
    public partial class Plots: UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            chartFirst.AxisX.Interval = 0.007;
            chartFirst.AxisY.Interval = 1;
            ...
            chartSecond.AxisX.Interval = 0.007;
            chartSecond.AxisY.Interval = 1;
            ...
            for (int i = 1; i<=32; i++ )
            {
                ...
                procent = ((double)listOfTasks2.FindAll(task => task.State != "виконано").Count / listOfTasks2.Count) * 100 ;
